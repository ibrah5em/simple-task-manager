...
<div class="d-flex align-items-center justify-content-between mb-4 anim-fade-up flex-wrap gap-3">
    <div>
        <h4 class="fw-bold mb-1 d-flex align-items-center gap-2" style="color:var(--text)">
            <i class="bi bi-calendar-check" style="color:var(--purple-500);"></i> Today
        </h4>
...
@if($tasks->isEmpty())
    <div class="glass-card p-5 text-center anim-fade-up anim-delay-1">
        <i class="bi bi-sun" style="font-size:3rem;color:var(--purple-400);opacity:.6;"></i>
        <p class="mt-3 mb-2 fw-semibold" style="color:var(--text)">You're all caught up!</p>
        <p style="color:var(--text-muted);font-size:.875rem">No tasks due today. Enjoy your day!</p>
                    ...
                    <tr class="anim-fade-up"
                        ...
                        <td class="d-none d-sm-table-cell" style="white-space:nowrap;">
                            @if($task->due_date)
                                ...
                                @if($isOverdue)
                                    <div style="font-size:.72rem;font-weight:600;color:#ef4444;margin-top:.2rem;">
                                        Overdue
                                    </div>
                                @endif
                            @else
